        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mb-8 group">
            ...
            <input
              ...
              className="w-full pl-14 pr-6 py-5 rounded-[1.5rem] bg-zinc-900/50 border border-white/10 focus:border-blue-500/50 outline-none transition-all text-lg"
            />
          </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-white/5 border-b border-white/10">
                    ...
                    <th className="p-6 text-right text-gray-400 font-bold uppercase text-xs tracking-widest">
                      Actions
                    </th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-white/5">
                  {filteredAttendees.map((ticket) => (
                    ...
                    >
                      ...
                      <td className="p-6">
                        {ticket.used ? (
                          <span className="bg-red-500/10 text-red-400 px-3 py-1 rounded-lg text-xs font-bold">
                            Scanned In
                          </span>
                        ) : (
                          <span className="bg-emerald-500/10 text-emerald-400 px-3 py-1 rounded-lg text-xs font-bold">
                            Waiting
                          </span>
                        )}
                      </td>
                      ...
                      <td className="p-6 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            onClick={() => setSelectedAttendee(ticket)}
                            className="p-3 rounded-xl bg-white/5 hover:bg-blue-500/20"
                          >
                            <Eye size={20} />
                          </button>
                          ...
                          <button
                            ...
                            className="p-3 rounded-xl bg-white/5 hover:bg-green-500/20"
                          >
                            <Check size={20} />
                          </button>
                          ...
                          <button
                            ...
                            className="p-3 rounded-xl bg-white/5 hover:bg-red-500/20"
                          >
                            <Ban size={20} />
                          </button>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 p-4 rounded-2xl">
                ...
                <p className="text-xl font-bold text-blue-400">
                  {selectedAttendee.ticket_type || 'Standard'}
                </p>
              </div>
